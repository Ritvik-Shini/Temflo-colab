        ...
        <div id="structure" className="md:scroll-m-[130px] scroll-m-28">
            ...
            <div className="rounded-md p-6 pt-3 border border-border dark:border-dark_border mt-6">
                <div className="flex items-center gap-4">
                    <h5 className="text-base text-MidnightNavyText dark:text-white font-medium mt-3 mb-1">
                        Symposium Tailwind Nextjs Templates
                    </h5>
                </div>
                                                    ...
                                                    <div className="flex flex-col justify-between gap-2 mt-2">
                                                        {
                                                            Counts.slice(0, 26).map((item, index) => {
                                                                return (
                                                                    <p key={index} className="text-xl text-SlateBlueText dark:text-opacity-80" >|</p>
                                                                )
                                                            })
                                                        }
                                                    </div>
                                                    <ul className="ps-5 md:ps-12 list-unstyled">
                                                                ...
                                                                <ul className="ps-5 md:ps-12 list-unstyled red">
                                                                    <li className="py-2">
                                                                        <div className="flex items-center gap-3">
                                                                            ...
                                                                            <span className="fs-9 text-SlateBlueText dark:text-opacity-80 ms-4">
                                                                            ...
                                                                            <ul className="ps-5 md:ps-12 list-unstyled">
                                                                                <li className="py-2">
                                                                                    <div className="flex items-center gap-8">
                                                                                        ...
                                                                                        <div className="flex items-center gap-3">
                                                                                            <p className="text-xl text-SlateBlueText dark:text-opacity-80" >|—</p>
                                                                                            <span className="font-medium text-SlateBlueText dark:text-opacity-80 flex items-center flex-wrap">
                                                                                                <Icon
                                                                                                    icon="tabler:folder"
                                                                                                    className="text-primary text-base inline-block me-2"
                                                                                                />
                                                                                                <p className="max-w-12 lg:max-w-full truncate" >authDialogContext.tsx</p>
                                                                                            </span>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                        ...
                                                        <li className="py-2">
                                                            <div className="flex items-center flex-wrap gap-3">
                                                                ...
                                                                <span className="fs-9 text-SlateBlueText dark:text-opacity-80">

...
import Image from 'next/image'; // Next.js Image optimization (best practice)

// 1. Data defining exactly what images and text you want
const digitalmuseum = [
  { 
    id: 1, 
...
export default function DigitalmuseumPage() {
  return (
    // 2. Main Page Container (Using Tailwind for spacing)
    <div className="container mx-auto px-4 py-10 md:py-16">
      
      {/* 3. Header Section (Same as your original but with better Tailwind) */}
